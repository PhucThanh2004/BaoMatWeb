...
<section class="breadcrumb-section"
    style="background-image: url('<c:url value="/image?fname=" /><c:out value="${account.cover_image}" />'); height: 250px; background-size: cover; background-position: center; width: 100%; position: relative;">
    <div class="profile-header">

        <div class="profile-avatar"
            style="margin-top: 175px; position: relative;">

            <c:url value="/image?fname=" var="imageBaseUrl"></c:url>
            <c:set var="imageUrl" value="${imageBaseUrl}${account.avatar}" />
            <img src="<c:out value='${imageUrl}' />" alt="Avatar" class="img-thumbnail mt-3"
                style="width: 150px;">
            <!-- Form Upload Avatar -->
            <form
                ...
                <input type="hidden" name="email" value="<c:out value='${account.email}' />">
                ...
                <label for="avatarUpload" class="edit-avatar-btn"
                    ...
                    <img src="<c:out value='${URL}/img/camera.png' />" alt="Edit Avatar"
        ...
        <form
            ...
            <label for="coverImageUpload" class="edit-cover-btn"
                ...
                <img src="<c:out value='${URL}/img/camera.png' />" alt="Edit Cover"
                ...
                <form
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            value="<c:out value='${account.name}' />" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email"
                            ...
                            value="<c:out value='${account.email}' />" readonly>
                    </div>
                        ...
                        <div class="address-item">
                            <div class="address-frame">
                                ...
                                <p>
                                    ...
                                    <c:out value="${addressItem.province}" />, 
                                    <c:out value="${addressItem.district}" />, 
                                    <c:out value="${addressItem.wards}" />, 
                                    <c:out value="${addressItem.detail}" />
                                </p>
                                <p>
                                    <strong>Số điện thoại:</strong> <c:out value="${addressItem.phone}" />
                                </p>
                                <form
                                    action="${pageContext.request.contextPath}/account/deleteAddress"
                                    method="POST">
                                    <input type="hidden" name="email" value="<c:out value='${account.email}' />">
                                    <input type="hidden" name="id" value="<c:out value='${addressItem.id}' />">
